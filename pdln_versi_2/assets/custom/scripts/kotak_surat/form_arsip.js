var FormEditTask = function () {
    return {
        ...
        init: function () {
            ...
            $('#submit_form_permohonan_baru').on('click', '#terarsip', function (e) {
                e.preventDefault();
                App.blockUI({
                    boxed: true,
                    message: 'Sedang di proses....'
                ...
                $.ajax({
                    ...
                    success: function (data)
                    {
                        if (data.status === true) {
                            window.setTimeout(function () {
                                App.unblockUI();
                                $.notific8('Surat Permohonan Berhasil Di Arsipkan', {
                                    heading: 'Sukses',
                                    theme: 'teal',
                                    life: 500,
                                    horizontalEdge: 'bottom',
                            ...
                            $('#g_kirim_persetujuan').show();
                             window.setTimeout(function() {
                             location.href=BASE_URL+"kotak_surat/approval/view_arsip/"+id_pdln;
                             }, 2000);
