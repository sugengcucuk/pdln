				...
				<form action="javascript:;" id="form_kegiatan" class="form-horizontal" kegiatan="form">
					<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-xs-4">
								<input name="temp_tujuan" id="temp_tujuan" type="hidden" />
...
<script src="<?php echo base_url(); ?>assets/custom/scripts/master/kegiatan.js?_dt=201606211658" type="text/javascript"></script>
