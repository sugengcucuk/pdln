...
<div class="row step-no-background">
                                    ...
                                    <?php if (!empty($list_approval)) { ?>
                                        ...
                                        <div class="well well-lg">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-4">
                                                   <?php if($data_pdln->id_signed){?>
                                                    <a href="<?php echo base_url('kotak_surat/approval/download/'.$id_pdln)?>" target="_blank"><button type="button" id="ppp" class="btn btn-sm green"> <i class="fa fa-file-pdf-o"> </i>  Preview Surat Persetujuan </button></a>
                                                    <?php }else{?>
                                                    <a href=""><button type="button" id="view_surat" class="btn btn-sm green"> <i class="fa fa-file-pdf-o"> </i>  Preview Surat Persetujuan </button></a>
                                                    <?php }?>
	...
	<script src="<?php echo base_url(); ?>assets/custom/scripts/kotak_surat/form_disetujui.js?_dt=201706211600" type="text/javascript"></script>