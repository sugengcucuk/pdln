                ...
                <?php if ($this->ion_auth->is_allowed(26, 'create')) {
                    ...
                    <div class="actions">  
                        <a href="<?php echo base_url(); ?>layanan/perpanjangan/add" class="nav-link ">
                            <button class="btn btn-outline blue"> <i class="fa fa-left"></i> Kembali </button> 	
                        </a>
...
<!-- END ROW --> 
<script src="<?php echo base_url(); ?>assets/custom/scripts/layanan/disetujui.js" type="text/javascript"></script>
