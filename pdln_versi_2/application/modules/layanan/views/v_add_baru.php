                        ...
                        <div class="form-body">
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                 <select name="level_pejabat" id="level_pejabat" class="form-control" >
                                                    <option value="">Pilih Klaster Pejabat</option>
                                    ...
                                    <fieldset id="pemohon_form_set">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <input type="hidden" name="list_pemohon" id="list_pemohon" value="<?php echo $unit_pemohon; ?>">
                                            </div>
                                            <div class="col-md-4">
                                ...
                                <div class="tab-pane" id="tab3">
                                        ...
                                        <div class="panel-group accordion" id="accordion_tab3_peserta">
                                            <div class="panel panel-info">
                                                <div class="panel-heading">
                                                    <h4 class="panel-title">
                                                        <a class="accordion-toggle accordion-toggle-styled collapsed" id="accordion-toggle-peserta" data-toggle="collapse" href="collapse_data_peserta" data-parent="#accordion_tab3_peserta" aria-expanded="false"><i class="fa fa-user"></i> Biodata Peserta </a>
                                                    </h4>
                                                </div>
                                                ...
                                                <div id="collapse_waktu_penugasan" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                                    <div class="panel-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="row">
                                                                <a  id="accordion-toggle-file" data-toggle="collapse" data-parent="#accordion_tab3_peserta" href="#collapse_dok_peserta" aria-expanded="false"><button class="btn btn-info">Berikutnya</button></a>
                                                            </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="panel panel-info">
                                                <div class="panel-heading">
                                                    <div class="panel-title">
                                                        <h4 class="panel-title">
                                                            <a class="accordion-toggle accordion-toggle-styled collapsed" id="accordion-toggle-file" href="#collapse_dok_peserta" data-toggle="collapse" data-parent="#accordion_tab3_peserta" aria-expanded="false"><i class="fa fa-file-pdf-o"> </i> Kelengkapan Dokumen Peserta</a>
                                                        </h4>
                                                    </div>
                                                </div>
                                                <div id="collapse_dok_peserta" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;">
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                            <a id="accordion-toggle-biaya" data-toggle="collapse" data-parent="#accordion_tab3_peserta" href="#collapse_pembiayaan_peserta" aria-expanded="false"><button class="btn btn-info">Berikutnya</button></a>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="table">
                                        <table class="table table-condensed table-striped table-hover table-bordered" id="table_list_peserta" style="width:100% !important;">
                                            <thead>
                                                <tr>
                                ...
                                <div class="tab-pane" id="tab4">
                                    ...
                                    <h4 class="form-section">Detail Peserta</h4>
                                        <div class="table">
                                            <table class="table table-condensed table-striped table-hover table-bordered" id="table_list_peserta_confirm" style="width:100% !important;">
                                                <thead>
                                                    <tr>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						<table class="table table-advanced table-striped table-condensed table-hover table-bordered" id="table_list_pemohon" style="width:100% !important;">
							<thead>
								<tr>
    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" data-dismiss="modal" class="btn default" id="kembali_ke_home"> <i class="fa fa-left"> </i> Kembali </button>
            </div>
        </div>
    </div>
</div>
