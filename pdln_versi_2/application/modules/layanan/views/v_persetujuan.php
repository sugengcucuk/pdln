            ...
            <div class="portlet-body">
                ...
                <div class="actions">
                    <a href="<?php echo base_url(); ?>layanan/pembatalan" class="nav-link ">
                        <button class="btn btn-outline blue" id="new_region"> <i class="fa fa-right"></i>Kembali</button>
                    </a>
                    <a href="<?php echo base_url(); ?>layanan/pembatalan/persetujuan_list" class="nav-link ">
                        <button class="btn btn-outline blue" id="new_region"> <i class="fa fa-plus"></i> Pembatalan Dari Persetujuan</button>     
                    </a>
            ...
            <div class="modal-header">
                ...
                <div class="modal-title">
                    <h3 class="font-blue-madison uppercase bold text-center">
                        <span class="title-text"><i class="fa fa-history"> </i> Permohonan Pembatalan  PDLN</span>
                    </h3>
                </div>
            </div>
                        ...
                        <div class="portlet light bordered">
                            <div class="portlet-title">
                                <div class="caption caption-md">
                                    ...
                                    <span class="caption-subject font-dark bold uppercase" id="nomer_register"></span>
...
<!-- END ROW -->
<script src="<?php echo base_url(); ?>assets/custom/scripts/layanan/list_persetujuan.js" type="text/javascript"></script>