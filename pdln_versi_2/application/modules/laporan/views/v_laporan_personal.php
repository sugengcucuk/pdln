                    ...
                    <form action="javascript:;" method="post" accept-charset="utf-8" id="form-filter-personal" name="form-filter-personal" class="form-horizontal">
                        <div class="form-body">
                            <div class="form-group">
                                <label class="control-label col-xs-3">Periode Tanggal Kegiatan</label>
                                <div class="col-xs-9">
                            ...
                            <!-- <div class="form-group">
                                <label class="control-label col-xs-3" for="nip">NIP/NIK/NAMA</label>
                                <div class="col-xs-3">
                                    <input type="text" name="nip" id="nip" class="form-control" placeholder="Masukkan NIP/NIK/NAMA" />
                                </div>
                            </div> -->
                            <!-- <div class="form-group">
        ...
        <div class="portlet box blue bordered">
            ...
            <div class="portlet-body">
                <div class="table-responsive">
                    <table class="table table-condensed table-bordered table-hover" id="tabel_laporan_personal">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center" style="vertical-align: middle;">Waktu Penugasan</th>
                            </tr>
                        </thead>
                        <tbody>
                        </tbody>
...
<script src="<?php echo base_url(); ?>assets/custom/scripts/laporan/personal.js?_dt=201706211600" type="text/javascript" charset="utf-8"></script>
